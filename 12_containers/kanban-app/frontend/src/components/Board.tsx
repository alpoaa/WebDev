...
import { type Column, type Id } from "../types/column"
...
const Board = () => {
    ...
    return (
        <div>
            <button onClick={createNewColumn} className="flex gap-2 cursor-pointer rounded-lg p-2 m-2 border-2 bg-red-200 ring-rose-700 hover:ring-4">
                <PlusIcon />
                Add column
            </button>
